...
def gen_data(network=defaultdict(set)):
    ...
    targets = set(open('/home/rishixtreme/PycharmProjects/poincare/data/targets.txt').read().split('\n'))
    ...
    with open('/home/rishixtreme/PycharmProjects/poincare/data/mammal_closure.tsv', 'w') as out:
...
class PoincareBase(object):
    def __init__(self, num_iter=140, num_negs=10, lr1=0.0005,lr2=0.00001,
                 dp='/home/rishixtreme/PycharmProjects/poincare/data/mammal_closure.tsv'):  # dim=2
        self.dim = 2
